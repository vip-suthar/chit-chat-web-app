...
let recStartTime;
let recElapsedTime;
let ChitChatTheme = "neon"; // neon - dark - forest - ghost ...
let swalBackground = "rgba(0, 0, 0, 0.7)"; // black - #16171b - transparent ...
let signalingServerPort = 8000; // must be same of server PORT
...
function getHtmlElementsById() {
  ...
  themeSelect = getId("ChitChatTheme");
...
function welcomeUser() {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      let message = {
        email: "",
        subject: "Please join our ChitChat Video Chat Meeting",
    ...
    event.channel.onmessage = (msg) => {
      switch (event.channel.label) {
        case "ChitChat_chat_channel":
          ...
          break;
        case "ChitChat_file_sharing_channel":
...
/**
 * Set ChitChat theme neon - dark - forest - sky - ghost
 * @param {*} theme
 */
...
function selectFileToShare() {
  ...
  Swal.fire({
    allowOutsideClick: false,
    background: swalBackground,
    imageAlt: "ChitChat-file-sharing",
  ...
  if (isImageURL(incomingFileInfo.fileName)) {
    ...
    reader.onload = (e) => {
      Swal.fire({
        ...
        imageAlt: "ChitChat-file-img-download",
        showDenyButton: true,
    ...
    Swal.fire({
      allowOutsideClick: false,
      background: swalBackground,
      imageAlt: "ChitChat-file-download",
      imageUrl: fileSharingImg,
      position: "center",
      title: "Received file",
      text:
...
function disableAllPeers(element) {
  ...
  Swal.fire({
    background: swalBackground,
    position: "center",
    imageAlt: "ChitChat-disable-" + element,
    imageUrl: confirmImg,
    title:
      element == "audio"
        ? "Mute everyone except yourself?"
...
function getAbout() {
  ...
  Swal.fire({
    background: swalBackground,
    position: "center",
    title: "<strong>WebRTC Made with 💙</strong>",
    imageAlt: "ChitChat-about",
    imageUrl: aboutImg,
    html: `
    <br/>
    <div id="about"><b>open source</b> project on<a href="https://github.com/vaishnav24khaitan" target="_blank"><h1><strong> GitHub </strong></h1></a></div>
    <div id="author"><a href="https://www.linkedin.com/in/vaishnav_khaitan24/" target="_blank">Author: Vaishnav Khaitan</a></div><br>
